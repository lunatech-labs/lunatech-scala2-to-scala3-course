...
class ReductionRuleSuite extends munit.FunSuite with SudokuTestHelpers {
  test(
    ...
    /** Note: test data in this test is a "ReductionSet": is consists of 9 cells (e.g. in a row or column or 3x3 block).
      * Each cell is represented by 9 characters: a space encodes a number not present in the cell, characters '1'
      * through '9' encode the presence of that digit in the cell.
      */
    ...
    val reducedInput1 = stringToReductionSet(
      Vector(
        " 23 56   ",
        "1        ",
        "   4     ",
    ...
    val reducedInput2 = stringToReductionSet(
      Vector(
        " 23 56   ",
        "1        ",
        "   4     ",
    ...
    val reducedInput3 = stringToReductionSet(
      Vector(
        " 23 5    ",
        "1        ",
        "   4     ",
  ...
  test(
    "Applying reduction rules should eliminate values in isolated complete sets of 5 values from occurrences in other cells (First reduction rule)") {
    val input = stringToReductionSet(
      Vector(
    ...
    val reducedInput = stringToReductionSet(
      Vector(
        "12345    ",
        "     67  ",
        "12345    ",
  ...
  test(
    "Applying reduction rules should eliminate values in 2 isolated complete sets of 3 values from occurrences in other cells (First reduction rule)") {
    val input = stringToReductionSet(
      Vector(
        "123      ",
        "123      ",
